...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Inserir novo Jogador</div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('insert_players') }}" enctype="multipart/form-data">
                        @csrf
                            {{--@method('put')
...
-->
                            ...
                            <div class="form-group row">
                                ...
                                <!--<input id="user_id" type="text" class="form-control @error('position_id') is-invalid @enderror" name="user_id" value="{{ old('position_id') }}" required autocomplete="description">-->
